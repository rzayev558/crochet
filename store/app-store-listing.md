...
crochet,knitting,row counter,stitch counter,yarn,stash,pattern,project,tracker,amigurumi,granny,knit,wool
...
accounts or network calls of its own. Answer "No, we do not collect data from
this app" — unless/until you add RevenueCat or analytics, which have their own
disclosures (see notes below).
